...
<%@page import="org.n52.sor.ISorRequest"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">

<%@page import="org.n52.sor.client.Client"%>
<%@page import="org.n52.sor.ISorRequest.SorMatchingType"%>
		...
		<tr>
			...
			<td>
				<select name="matchingTypeString" class="inputField">
					<%
					SorMatchingType[] types = ISorRequest.SorMatchingType.values();
					for(SorMatchingType t : types) {
				    %>
