				...
				function() {
					...
					return {
						...
						controller : function($scope, $element, $attrs) {
							...
							// with the searchFilter the suggestions get
							// filtered
							$scope.searchFilter;

							// the index of the suggestions that's currently
							// selected
							...
							$scope.$watch('searchParam', function() {
								...
								// function thats passed to on-type attribute
								// gets executed
								if (onType)
						...
						link : function(scope, element, attrs) {
							...
							element
									.keydown(function(e) {
										...
										// implementation of the up and down
										// movement in the list of suggestions
										switch (keycode) {
										case key.up:
											console.log("UP");
											...
											if (index !== -1)
												preSelect(angular.element(this)
														.find('li')[index].innerText);
