...
<script>
	function validateForm() {
		...
		if (name == null || name == "" || password.trim() == null
				|| password.trim() == "") {

			alert("Enter a valid credential first!");
			return false;
		}
...
<body>
	...
	<div class="container">
		<form method="post" class="form-signin" name="registerForm"
			...
			<input type="text" class="form-control" placeholder="Email address"
				id="username_or_email" name="username" /> <input type="password"
				class="form-control" placeholder="Password" id="password"
				name="password" /> <input type="password" class="form-control"
				placeholder="Repeat Password" id="repeat-password"
				name="password_repeat"> <label class="checkbox">
	...
	<script src="../${context}/OSSUI/scripts/bootstrap.min.js"></script>
