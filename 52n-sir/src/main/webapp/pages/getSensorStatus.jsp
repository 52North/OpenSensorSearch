...
<p>The status request can contain either sensor identification or search criteria.</p>
...
<ul class="inputTablesList">
	...
	<table>
		<tr>
			<td colspan="2">Sensor Identification can be done either by sensor ID in SIR or by service reference (using three parameters):</td>
		</tr>
		<tr>
			<td class="inputTitle">Sensor ID In SIR</td>
			<td><input type="text" class="inputField" name="sensorIDInSIR"
				size="100" value="<%=getSensorStatus.getSensorIDInSIR()%>" /></td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
		</tr>
		...
		<tr>
			...
			<td><input type="text" class="inputField" name="serviceType"
				size="100" value="<%=getSensorStatus.getServiceType()%>" /></td>
		</tr>
		<tr>
	...
	<table>
		...
		<tr>
			<td colspan="2">Phenomenon (multiple possible manually, SOR parameters are optional):</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">Bounding Box (for ows:BoundingBoxType, e.g. 'lon lat'):</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">Time period (for gml:TimeInstantType, e.g. '1990-01-01 00:00:00'):</td>
		</tr>
		<tr>
	...
	<table>
		<tr>
			...
			<td><input type="text" class="inputField" name="propertyName"
		...
		<tr>
			...
			<td><input type="text" class="inputField" name="uomConstraint"
		...
		<tr>
			...
			<td><input type="text" class="inputField" name="isNotEqualTo"
				value="<%=getSensorStatus.getIsNotEqualTo()%>" size="30" /></td>
		</tr>
		<tr>
			<td class="inputTitle">is greater than</td>
			<td><input type="text" class="inputField" name="isGreaterThan"
		...
		<tr>
			...
			<td><input type="text" class="inputField"
				...
				value="<%=getSensorStatus.getIsGreaterThanOrEqualTo()%>" size="30" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" class="inputField"
				...
				value="<%=getSensorStatus.getIsBetweenLowerBoundary()%>" size="30" />
			<input type="text" class="inputField" name="isBetweenUpperBoundary"
				value="<%=getSensorStatus.getIsBetweenUpperBoundary()%>" size="30" /></td>
		</tr>
	</table>
	</li>
</ul>
...
<p class="textareaBorder"><textarea id="requestStringArea"
	class="mediumTextarea" name="requestString" rows="10" cols="10"><%=getSensorStatus.getRequestString()%></textarea></p>
<p><input type="submit" name="sendRequest" value="Send request" /></p>
</form>
<p class="textareaBorder"><textarea id="responseStringArea"
	class="mediumTextarea" rows="10" cols="10"><%=getSensorStatus.getResponseString()%></textarea></p>
