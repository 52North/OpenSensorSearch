      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
            ...
            <p>In the specified field , please enter a valid sensor provider for harvesting</p>
            <form id="harvest-form">
            	<input type="text" class="span4" name="url"></input>
            </form>
            <p><a href="#" class="btn btn-primary btn-large" onclick="uploadServer()">Add server &raquo;</a></p>
          </div>
      </div>
  </div>
